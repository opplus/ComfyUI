...
clone_or_pull https://ghp.ci/https://github.com/shiimizu/ComfyUI_Comfyroll_CustomNodes.git
clone_or_pull https://ghp.ci/https://github.com/shiimizu/ComfyUI_Custom_Nodes_AlekPet.git
clone_or_pull https://ghp.ci/https://github.com/shiimizu/ComfyUI_LayerStyle.git
clone_or_pull https://ghp.ci/https://github.com/shiimizu/comfyui-mixlab-nodes.git
clone_or_pull https://ghp.ci/https://github.com/shiimizu/ComfyUI_Noise.git
...
clone_or_pull https://ghp.ci/https://github.com/storyicon/ComfyUI-segment-anything-2.git
clone_or_pull https://ghp.ci/https://github.com/twri/sdxl_prompt_styler.git
clone_or_pull https://ghp.ci/https://github.com/opplus/comfyui-reactor-node.git
clone_or_pull http://oplus:DLMZkDKqt89eRwiXJS3B@gitlab.vigekoo.com/lm/dlm-comfyui-nodes.git
clone_or_pull https://ghp.ci/https://github.com/cubiq/PuLID_ComfyUI.git
clone_or_pull https://ghp.ci/https://github.com/cubiq/ComfyUI-Florence2.git
clone_or_pull https://ghp.ci/https://github.com/cubiq/ComfyUI-BrushNet.git
clone_or_pull https://ghp.ci/https://github.com/cubiq/SDXL_EcomID_ComfyUI.git
clone_or_pull https://ghp.ci/https://github.com/cubiq/style_aligned_comfy.git
...
clone_or_pull https://ghp.ci/https://github.com/MrForExample/ComfyUI-QualityOfLifeSuit_Omar92.git
clone_or_pull https://ghp.ci/https://github.com/MrForExample/ComfyUI-CogVideoXWrapper.git
...
clone_or_pull https://ghp.ci/https://github.com/SLAPaper/comfyui-inpaint-nodes.git
clone_or_pull https://ghp.ci/https://github.com/SLAPaper/ComfyUI-Inpaint-CropAndStitch.git
